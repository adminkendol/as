    ...
    <table class="table table-bordered table-responsive">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a type="button" href="<?php echo base_url().'core/edittype/'.$s->id; ?>" class="btn-sm btn-primary">Edit</a>
                    <a type="button" href="<?php echo base_url().'core/remtype/'.$s->id; ?>" class="btn-sm btn-danger">Remove</a>
                </td>
            </tr>
            <?php 
                }
